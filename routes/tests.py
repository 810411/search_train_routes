...
class RouteTestCase(TestCase):
    ...
    def test_model_city_duplicate(self):
        try:
            ...
            self.assertEqual({'name': ['Город with this Город already exist.']}, e.message_dict)
    ...
    def test_model_train_duplicate(self):
        try:
            ...
            self.assertEqual({'name': ['Поезд с таким Номер поезда уже существует.']}, e.message_dict)
